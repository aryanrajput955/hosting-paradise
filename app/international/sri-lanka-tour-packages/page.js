...
const tours = [
  {
    title: "Sri Lanka Cultural & Wildlife Escape",
    dates: ["Nov 10", "Dec 05", "Jan 15"],
    prices: ["Starting ₹89,990*", "₹74,990*"],
    image: "https://wallpaperaccess.com/full/1307513.jpg",
    duration: "8D/7N",
    group: "Group Tour",
    link: "/trip-packages/sri-lanka-packages",
  },
...
const SriLankaTour = () => {
  ...
  const handleCloseModal = () => {
    ...
    setFormData({ name: '', phone: '', date: null, travellers: '', email: '', package: 'Sri Lanka Tour' });
  };
  ...
  return (
    <>
      {/* Hero Section - Sri Lanka Background */}
      <div
        ...
        style={{ backgroundImage: "url('https://wallpaperaccess.com/full/1375605.jpg')" }} // Replace with actual hero image
      >
        <h2
        ...
        >
          ...
          >
            <option value="Sri Lanka Tour">Sri Lanka Tour</option>
            <option value="Cultural & Wildlife">Cultural & Wildlife Escape</option>
            <option value="Hill Country & Beaches">Hill Country & Beaches</option>
          </select>
      ...
      <div className="flex flex-col items-center text-center my-12 px-4 w-full max-w-6xl mx-auto bg-gradient-to-b from-[#F1FDF3] to-white rounded-lg shadow-lg p-8">
        <motion.h2
          ...
          transition={{ duration: 0.5 }}
        >
          Explore the Pearl of the Indian Ocean — Culture, Wildlife, Hills & Beaches Together
        </motion.h2>
        <motion.p
        ...
        >
          Explore Sri Lanka’s serenity and natural beauty with our budget-friendly Sri Lanka tour packages. Sri Lanka, the Pearl of the Indian Ocean, is an island country located in South Asia. Home to ancient ruins, lush tea plantations, golden beaches, and rich wildlife — it’s the perfect destination for culture, adventure, and relaxation.
        </motion.p>
        <div
          ref={contentRef}
        ...
        >
          <div className="py-6 space-y-8">
            <div>
              <h3 className="text-2xl font-semibold text-green-900 mb-4">What Sri Lanka Tours Include</h3>
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                <li>Discover Sri Lanka’s iconic Cultural Triangle: ancient kingdoms like Anuradhapura & Polonnaruwa, and the majestic Sigiriya Rock Fortress.</li>
                <li>Travel through hill country (Nuwara Eliya, Ella) with its misty tea gardens, scenic train rides over historic routes and mountain passes.</li>
                <li>Go wildlife spotting in parks like Yala or Udawalawe — elephants, leopards, birds & more.</li>
                <li>Enjoy colonial charm in places like Galle Fort.</li>
                <li>Relax on beautiful beaches in Bentota or Mirissa. Whale watching during season.</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-semibold text-green-900 mb-4">Best Time to Visit</h3>
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                <li><strong>November–March:</strong> Best for beaches on the south & west coast; dry weather</li>
                <li><strong>May–September:</strong> Ideal for east coast beaches (Trincomalee, Passikudah)</li>
                <li>Hill country & cultural sites are great year-round</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-semibold text-green-900 mb-4">Highlights</h3>
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                <li>UNESCO sites: Sigiriya, Dambulla Cave Temple, Kandy Temple of the Tooth</li>
                <li>Scenic train journey from Kandy to Ella</li>
                <li>South coast beaches and colonial Galle Fort</li>
                <li>Wildlife safari in Yala or Udawalawe</li>
                <li>Tea plantation walks & factory tours</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-semibold text-green-900 mb-4">Group Trip Benefits</h3>
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                <li>Expert English-speaking guides and dedicated group coordinators.</li>
                <li>Comfortable AC transportation throughout.</li>
                <li>Handpicked hotels — boutique, heritage, or eco-resorts.</li>
                <li>Authentic Sri Lankan cuisine & cultural experiences.</li>
                <li>Group discounts & fixed departures.</li>
                <li>24/7 local support.</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-semibold text-green-900 mb-4">Custom & Private Options</h3>
              <p className="text-gray-600 leading-relaxed mb-2">
                Prefer a private journey? We offer fully customizable Sri Lanka tours:
              </p>
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                <li>Luxury villas, eco-lodges, or heritage stays</li>
                <li>Slow-paced or adventure-packed itineraries</li>
                <li>Special experiences: Ayurvedic spa, cooking classes, sunrise at Sigiriya</li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-semibold text-green-900 mb-4">Who Would Love These Tours</h3>
              <p className="text-gray-600 leading-relaxed">
                Perfect for families, couples, friends, wildlife lovers, culture enthusiasts, and anyone seeking a blend of history, nature, and beach relaxation.
              </p>
            </div>
            <div>
              <h3 className="text-2xl font-semibold text-green-900 mb-4">Ready to Plan Your Sri Lankan Escape?</h3>
              <p className="text-gray-600 leading-relaxed">
                Share your travel dates, group size, and interests (culture, wildlife, beaches, hills, or all-in-one), and we’ll craft your perfect Sri Lanka itinerary — group or private — with confirmed pricing and departures.
              </p>
            </div>
          </div>
        </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <DatePicker
                      ...
                      minDate={new Date()}
                      className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#00453A] focus:ring-[#00453A] pr-10"
