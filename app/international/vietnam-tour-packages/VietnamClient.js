...
const tours = [
  {
    title: "Ho Chi Minh, Hanoi & Halong Bay",
    dates: ["Mar 20", "Apr 05", "May 15"],
    prices: ["Starting ₹89,999*", "₹79,999*"],
    image: "/optimised/vietnam1.jpg",
    duration: "8D/7N",
    group: "Group Tour",
    link: "/trip-packages/vietnam-8day-packages",
  },
  {
    title: "Hoi An, Da Nang & Phu Quoc Beach Escape",
    dates: ["Apr 10", "May 01", "Jun 12"],
    prices: ["Starting ₹1,09,999*", "₹94,999*"],
    image: "/optimised/vietnam2.jpg",
    duration: "10D/9N",
    group: "Group Tour",
    link: "/trip-packages/vietnam-10day-packages",
  },
  {
    title: "Amazing Vietnam Tour",
    dates: ["Mar 25", "Apr 18", "Sep 10"],
    prices: ["Starting ₹99,999*", "₹84,999*"],
    image: "/optimised/vietnam3.jpg",
    duration: "6D/5N",
    group: "Group Tour",
    link: "/trip-packages/vietnam-6day-packages",
  },
  {
    title: "Sapa Trekking & Northern Highlands",
    dates: ["Mar 25", "Apr 18", "Sep 10"],
    prices: ["Starting ₹99,999*", "₹84,999*"],
    image: "/optimised/vietnam7.jpg",
    duration: "4D/3N",
    group: "Group Tour",
    link: "/trip-packages/vietnam-4day-packages",
  },
   {
    title: "vietnam new year celebration ",
    dates: ["Mar 25", "Apr 18", "Sep 10"],
    prices: ["Starting ₹99,999*", "₹84,999*"],
    image: "/optimised/vietnam5.jpg",
    duration: "4D/3N",
    group: "Group Tour",
    link: "/trip-packages/vietnam-newyear-packages",
  },
   {
    title: "Saigon city packages",
    dates: ["Mar 25", "Apr 18", "Sep 10"],
    prices: ["Starting ₹39,999*", "₹29,999*"],
    image: "/optimised/vietnam6.jpg",
    duration: "4D/3N",
    group: "Group Tour",
    link: "/trip-packages/vietnam-saigoncity-packages",
  },
];
...
const VietnamTour = () => {
  ...
  const handleCloseModal = () => {
    ...
    setFormData({ name: '', phone: '', date: null, travellers: '', email: '', package: 'Vietnam Tour' });
  };
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ backgroundImage: "url('/optimised/bridge.webp')" }}
      >
        <h2
        ...
        >
          ...
          >
            <option value="Vietnam Tour">Vietnam Tour</option>
            <option value="Halong Bay Cruise">Halong Bay Cruise</option>
            <option value="Sapa Trekking">Sapa Trekking</option>
            <option value="Phu Quoc Beach">Phu Quoc Beach</option>
          </select>
      ...
      <div className="flex flex-col items-center text-center my-12 px-4 w-full max-w-6xl mx-auto bg-gradient-to-b from-[#F1FDF3] to-white rounded-lg shadow-lg p-8">
        <motion.h2
          ...
          transition={{ duration: 0.5 }}
        >
          Explore Vietnam with Paradise Bliss Tours – A Journey of Culture, Nature & Adventure
        </motion.h2>
        <motion.p
        ...
        >
          Vietnam, the jewel of Southeast Asia, is a land of vibrant culture, breathtaking landscapes, and unforgettable experiences. From the bustling streets of Ho Chi Minh City to the tranquil waters of Halong Bay, from the lantern-lit alleys of Hoi An to the terraced hills of Sapa, Vietnam offers something for every traveler.
        </motion.p>
        <div
          ref={contentRef}
