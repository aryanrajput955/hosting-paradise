...
const tours = [
  {
    ...
    prices: ["Starting ₹2,49,990*", "₹2,19,990*"],
    image:"/optimised/dubai3.jpg",
    duration: "7D/6N",
    group: "Group Tour",
    link: "/trip-packages/dubai-group-trip", // Updated link
  },
...
const DubaiTour = () => {
  ...
  const handleCloseModal = () => {
    ...
    setFormData({ name: '', phone: '', date: null, travellers: '', email: '', package: 'Dubai Tour' });
  };
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ backgroundImage: "url('https://images.alphacoders.com/108/1087214.jpg')" }}
      >
        <h2
      ...
      <div className="flex flex-col items-center text-center my-12 px-4 w-full max-w-6xl mx-auto bg-gradient-to-b from-[#F1FDF3] to-white rounded-lg shadow-lg p-8">
        <motion.h2
          ...
          transition={{ duration: 0.5 }}
        >
          Experience Magic & Luxury in Dubai — Your Gateway to Adventure, Culture & Glamour
        </motion.h2>
        <motion.p
        ...
        >
          Dubai is a city where futuristic skylines meet centuries-old traditions, desert dunes contrast with sparkling beaches, and unforgettable shopping meets adrenaline-pumping rides. At Paradise Bliss Tours, our Dubai packages combine the best of it all — designed for friends, families, couples, or solo travelers, every package promises something special.
        </motion.p>
        <div
          ref={contentRef}
