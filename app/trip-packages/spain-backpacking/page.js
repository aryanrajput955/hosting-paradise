      ...
      <div className="space-y-4">
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>Local guides & selected experiences.</li>
            <li>Entry fees for listed attractions.</li>
            <li>Transfers within Europe & support throughout.</li>
          </ul>
        </div>
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>Visa fees & associated costs.</li>
            <li>Personal expenses, tips, and optional add-ons.</li>
            <li>Anything not explicitly listed under “Included”.</li>
          </ul>
        </div>
      </div>
    ),
