...
// Almaty Images (replace with actual paths)
const heroImage = "/optimised/Arbat_Street_in_MSK-transformed.jpeg";
const highlightImages = [
  "/optimised/Shymbulak_Ski_Resort-2bkdCZaFt-transformed.jpeg",
  "/optimised/almaty1.jpg",
  "/optimised/kotob.avif",
  "/optimised/Arbat_Street_in_MSK-transformed.jpeg",
];
const rightSideImage = "/img/logo.png";

// Quick Facts about Almaty
const quickFacts = [
  { text: "Almaty was the capital of Kazakhstan until 1997." },
  { text: "Shymbulak Ski Resort is just 30 km from the city center." },
  { text: "Zenkov Cathedral is one of the tallest wooden buildings in the world." },
  { text: "Kok Tobe Hill offers 360° panoramic views of Almaty." },
];
...
const itinerary = [
  {
    ...
    desc: "Fly from India to Almaty, Kazakhstan. Upon arrival at Almaty International Airport, our representative will assist you with the transfer to your hotel. Complete check-in formalities and relax. Overnight stay at your hotel in Almaty."
  },
  {
    day: "Day 2",
    title: "Shymbulak Ski Resort & City Exploration",
    desc: "After breakfast, embark on a scenic drive to Shymbulak Ski Resort, located approximately 30 km from Almaty. Enjoy a cable car ride to the top, offering panoramic views of the surrounding mountains. Return to Almaty for a leisurely walk through Panfilov Park, home to the Zenkov Cathedral, one of the tallest wooden Orthodox churches in the world. In the evening, explore Arbat Street, a bustling pedestrian avenue filled with shops, cafes, and street performances. Overnight stay in Almaty."
  },
  {
    day: "Day 3",
    title: "Almaty City Tour & Kok Tobe Hill",
    desc: "After breakfast, visit Panfilov’s 28 Guardsmen Park and the World War II Memorial dedicated to the Panfilov Heroes. Then, take a short cable car ride to Kok Tobe Hill, offering stunning views of the city. Enjoy leisure time at the hilltop park with shops and restaurants. Return to your hotel in the evening and relax. Overnight stay in Almaty."
  },
  {
    day: "Day 4",
    title: "Departure",
    desc: "After breakfast, check out from your hotel. Proceed to Almaty International Airport for your return flight to India. Depart with cherished memories of your Almaty adventure."
  },
];

// Highlights
const highlights = [
  { title: "Shymbulak Ski Resort", image: highlightImages[0], desc: "Cable car ride with mountain views." },
  { title: "Zenkov Cathedral", image: highlightImages[1], desc: "Tallest wooden Orthodox church in the world." },
  { title: "Kok Tobe Hill", image: highlightImages[2], desc: "Panoramic city views and leisure park." },
  { title: "Arbat Street", image: highlightImages[3], desc: "Vibrant pedestrian zone with cafes & shops." },
];
...
const faqs = [
  ...
  { question: "Do I need a visa to visit Kazakhstan?", answer: "Indian passport holders get visa on arrival for up to 14 days. Confirm with your airline." },
  { question: "Are flights included?", answer: "No, international flights are not included. Airport transfers are provided." },
  { question: "What is the accommodation standard?", answer: "3 nights in a comfortable 3-star hotel, centrally located, twin/double sharing." },
  { question: "Can dietary requirements be accommodated?", answer: "Yes, vegetarian and halal options available with advance notice." },
  { question: "Is the tour shared or private?", answer: "Shared group tour with English-speaking guide and AC vehicle." },
  { question: "What currency should I bring?", answer: "Kazakhstani Tenge (KZT). USD also widely accepted in Almaty." },
  { question: "Is winter gear provided at Shymbulak?", answer: "No, but rentals available on-site. Dress warmly in winter." },
...
const importantInfo = [
      ...
      <div className="space-y-4">
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>3 nights at a 3-star hotel with daily breakfast</li>
            <li>All transfers and sightseeing by AC vehicle (shared basis)</li>
            <li>Visits: Shymbulak Ski Resort, Panfilov Park, Zenkov Cathedral, Arbat Street, Kok Tobe Hill</li>
            <li>Airport pick-up and drop-off</li>
            <li>English-speaking local guide</li>
            <li>Cable car tickets (Shymbulak & Kok Tobe)</li>
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>Round-trip international flights from India</li>
            <li>Lunches and dinners</li>
            <li>Personal expenses, shopping, optional activities</li>
  ...
  },
  {
    ...
    content: (
      <p>
        <strong>Double-Sharing Price:</strong> ₹34,999 per person<br />
        <em>Seasonal offers and group discounts available.</em>
      </p>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-2">
        <p><strong>Spring (Apr–Jun):</strong> Pleasant, blooming landscapes</p>
        <p><strong>Summer (Jun–Aug):</strong> Ideal for outdoor activities</p>
        <p><strong>Autumn (Sep–Oct):</strong> Mild, vibrant fall colors</p>
        <p><strong>Winter (Nov–Mar):</strong> Snow sports at Shymbulak</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        <li>Wear comfortable shoes for walking in parks and Arbat Street.</li>
        <li>Stay hydrated; bottled water provided in vehicle.</li>
        <li>Follow guide instructions during cable car rides.</li>
        <li>Dress warmly in winter; layers recommended year-round.</li>
...
export default function AlmatyShortTrip4DayPackage() {
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 to-[#00453A]/40 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            >
              Paradise Bliss Tours – Quick Getaway to Kazakhstan
            </motion.p>
            <motion.button
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
        ...
        >
          <div className="space-y-4">
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
              Discover the vibrant city of Almaty in just 4 days with our specially designed Almaty 3N/4D Short Trip. Perfect for travelers seeking a brief yet immersive experience, this package covers the city's top attractions, rich culture, and stunning landscapes.
            </p>
            <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
              ...
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Focus:</strong> City, Mountains, Culture
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Price:</strong> ₹34,999 per person
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Vibe:</strong> Relaxed, scenic, cultural
              </li>
            </ul>
          </div>
        ...
        >
          <div>
            ...
            <div className="flex items-baseline space-x-3">
              <span className="text-4xl font-bold text-[#00453A]">₹34,999</span>
              <span className="text-sm text-gray-600">per person</span>
            </div>
            <p className="text-sm text-gray-600 mt-2 font-sans">Group & seasonal discounts available.</p>
            ...
            <ul className="space-y-3 text-gray-700 font-sans">
              ...
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Shymbulak & Kok Tobe cable cars</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> All transfers & guided tours</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Daily breakfast + 24/7 support</li>
            </ul>
          </div>
      ...
      {isModalOpen && (
        ...
        >
          ...
          >
            ...
            <div className="mb-4">
              <Image src={heroImage}
                alt="Almaty Short Trip"
                width={400}
                height={128}
                className="w-full h-32 object-cover rounded-lg"
                quality={75}
              />
              <h3 className="mt-3 text-lg font-bold text-[#00453A] font-sans">Almaty 3N/4D Short Trip</h3>
            </div>
