...
// 9-Day Spiti Valley Full Circuit Itinerary (adjusted for consistency)
const itinerary = [
  {
    day: "Day 1",
...
// FAQ data - Tailored for Spiti Full Circuit
const faqs = [
  { question: "What is the duration of the Spiti Full Circuit tour?", answer: "9 Days / 8 Nights, including round-trip travel from Delhi." },
  ...
  { question: "What is the best time for the Spiti Full Circuit?", answer: "June to September for accessible roads and pleasant weather; roads close in winter." },
  ...
  { question: "Are transfers from Delhi included?", answer: "Yes, AC Volvo bus for round-trip Delhi-Shimla-Manali-Delhi; all internal transfers by tempo traveller." },
  { question: "What should I pack for the trip?", answer: "Warm layers, gloves, sunglasses, sunscreen, comfortable walking shoes; nights can drop to 0°C." },
...
// Important Information data - Adapted for Spiti Full Circuit
const importantInfo = [
  {
      ...
      <div className="space-y-4">
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>Accommodation: 7 nights hotels + 1 night camping + 2 nights Volvo.</li>
            <li>Meals: 9 breakfasts + 9 dinners.</li>
            <li>AC Volvo Delhi round-trip & internal tempo traveller transfers.</li>
            <li>Experienced tour leader, 24x7 oxygen & first aid support.</li>
            <li>Sightseeing as per itinerary & Inner Line Permits.</li>
          </ul>
        </div>
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>Lunch & beverages not specified.</li>
            <li>Entry fees to monuments & camera charges.</li>
            <li>5% GST.</li>
          </ul>
        </div>
      </div>
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        <em>Pricing varies by group size and season (June–September). Scheduled batches: 10th Jun, 25th Jun, 15th Aug, 5th Sep 2025. Early booking advised.</em>
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        Perfect for culture seekers, photographers, and nature lovers craving Himalayan serenity, ancient monasteries, and offbeat villages. A transformative journey blending adventure, spirituality, and raw beauty.
      </p>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        <li>Route accessible June–September; monsoons or landslides may alter itinerary.</li>
        <li>AMS precautions: Hydrate, rest, and use provided oxygen; consult doctor for high-altitude travel.</li>
        <li>Inner Line Permit mandatory for restricted zones; valid ID required.</li>
        <li>Group size 8-15; itinerary flexible based on weather and road conditions.</li>
      </ul>
    ),
  },
];
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-black/50 to-[#00453A]/30 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            >
              9 Days of Monasteries, Lakes & Himalayan Magic
            </motion.p>
            <motion.button
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
        ...
        >
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
              ...
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Vibe:</strong> Cultural, serene, adventurous
              </li>
            </ul>
          </div>
      ...
      >
        ...
        >
          <div>
            ...
            <p className="text-sm text-gray-600 mt-2 font-sans">Starting price per person. Includes Volvo transfers, camping & support.</p>
            ...
            <ul className="space-y-3 text-gray-700 font-sans">
              ...
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> AC Volvo & tempo transfers</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Tour leader & oxygen support</li>
            </ul>
          </div>
          ...
          >
            ...
            <div className="mb-4">
              <Image src={heroImage}
                ...
                quality={75}
              />
              <h3 className="mt-3 text-lg font-bold text-[#00453A] font-sans">Spiti Full Circuit – 9 Days / 8 Nights - Paradise Bliss Tours</h3>
            </div>
