...
// Quick Facts about Manali–Kasol–Sissu
const quickFacts = [
  { text: "Manali is nestled in the Himalayas, known for its cedar forests and adventure sports." },
  { text: "The Atal Tunnel provides a scenic shortcut to Sissu, offering stunning mountain views." },
  { text: "Kasol is a backpacker's paradise with riverside cafés and easy treks like Chalal Village." },
  { text: "Manikaran Gurudwara features natural hot springs believed to have healing properties." },
];

// Itinerary data - Updated for 3N/4D Manali–Kasol–Sissu
const itinerary = [
  {
    day: "Day 1",
    title: "Departure from Delhi – Arrival in Manali",
    desc: "Evening: Depart from Delhi around 6:00 PM in an AC vehicle. Overnight: Travel overnight to Manali."
  },
  {
    day: "Day 2",
    title: "Explore Manali – Solang Valley & Sissu",
    desc: "Morning: Arrive in Manali and check-in to your accommodation. Activities: Visit Hadimba Temple, a unique wooden structure surrounded by cedar forests. Explore Old Manali and Mall Road for local shopping and café hopping. Afternoon: Drive to Solang Valley for adventure activities like skiing, paragliding, or zorbing (at your own cost). Evening: Proceed to Sissu via the Atal Tunnel, enjoying the scenic drive. Overnight: Stay in Sissu."
  },
  {
    day: "Day 3",
    title: "Sissu – Kasol – Manikaran",
    desc: "Morning: After breakfast, depart for Kasol. Activities: Explore the Kasol Market and enjoy riverside cafés. Trek to Chalal Village (approximately 3 km round trip) for a peaceful nature walk. Visit the Manikaran Gurudwara, known for its hot springs. Evening: Enjoy a bonfire and dinner at your accommodation in Kasol. Overnight: Stay in Kasol."
  },
  {
    day: "Day 4",
    title: "Departure to Delhi",
    desc: "Morning: After breakfast, check out from your accommodation. Afternoon: Depart for Delhi. Evening: Arrive in Delhi by evening, concluding your trip."
  },
];

// Highlights data - Updated for Manali–Kasol–Sissu
const highlights = [
  { title: "Hadimba Temple", image: highlightImages[0], desc: "Ancient wooden temple amid deodar forests in Manali." },
  { title: "Solang Valley Adventures", image: highlightImages[1], desc: "Thrilling activities like paragliding and zorbing with Himalayan backdrop." },
  { title: "Kasol Riverside", image: highlightImages[2], desc: "Vibrant market and serene Parvati River cafés." },
  { title: "Manikaran Hot Springs", image: highlightImages[3], desc: "Sacred Gurudwara with therapeutic geothermal waters." },
];

// FAQ data - Tailored for Manali–Kasol–Sissu tour
const faqs = [
  { question: "What is the best time to visit Manali and Kasol?", answer: "The ideal period is March to June for pleasant weather and adventure activities, or October to February for snow experiences." },
  ...
  { question: "Is travel insurance included?", answer: "No, travel insurance is not included. We strongly recommend purchasing comprehensive coverage for medical and adventure activities." },
  { question: "What is the accommodation standard?", answer: "Comfortable hotels in Manali and Kasol on double/triple sharing basis with basic amenities." },
  ...
  { question: "Are adventure activities in Solang included?", answer: "No, activities like paragliding are at your own cost and subject to weather conditions." },
  { question: "Are transfers from Delhi included?", answer: "Yes, round-trip AC vehicle transfers from Delhi are included for the entire journey." },
  { question: "What currency should I bring?", answer: "Indian Rupees (INR). ATMs are available in Manali and Kasol; cards accepted at major establishments." },
  { question: "Is the Chalal trek suitable for beginners?", answer: "Yes, the 3 km round trip is easy and scenic, ideal for all fitness levels with proper footwear." },
...
// Important Information data - Adapted for Manali–Kasol–Sissu
const importantInfo = [
  {
      ...
      <div className="space-y-4">
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>Accommodation: 2 nights in hotels at Manali and 1 night in Kasol (Double/Triple Sharing).</li>
            <li>Meals: 6 meals (2 on Day 2: Breakfast & Dinner; 2 on Day 3: Breakfast & Dinner; 2 on Day 4: Breakfast).</li>
            <li>Transportation: AC vehicle for Delhi–Manali–Kasol–Delhi journey.</li>
  ...
  },
  {
    ...
    content: (
      <p>
        Ideal for adventure enthusiasts, families, couples, and nature lovers seeking a mix of Himalayan drives, cultural sites, and relaxed treks. A scenic journey through Manali's adventures and Kasol's tranquility.
      </p>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        <li>Ensure moderate fitness for light treks; consult a doctor for high-altitude concerns.</li>
        <li>Stay hydrated, especially during drives through the Atal Tunnel and mountain roads.</li>
        <li>Wear comfortable clothing, sturdy shoes for treks, and layers for variable weather.</li>
        <li>Follow the team captain's instructions during sightseeing and adventure spots.</li>
        <li>Respect local customs: modest attire at temples and Gurudwaras, no littering in natural areas.</li>
      </ul>
    ),
  },
];
...
export default function ManaliKasolSissuPackage() {
        ...
        >
          <div className="space-y-4">
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
              Discover the majestic Himalayas on this 4-day journey from Manali's adventures through Sissu's serene valleys to Kasol's bohemian charm with Paradise Bliss Tours. Experience temples, hot springs, and scenic drives.
            </p>
            <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
              ...
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Destination:</strong> Manali–Kasol–Sissu (Delhi Round Trip)
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
              ...
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Vibe:</strong> Adventurous, scenic, relaxing
              </li>
            </ul>
          </div>
        ...
        >
          <div>
            ...
            <ul className="space-y-3 text-gray-700 font-sans">
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> 3 nights hotel/camp stays</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> 6 specified meals</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> AC vehicle transfers & sightseeing</li>
