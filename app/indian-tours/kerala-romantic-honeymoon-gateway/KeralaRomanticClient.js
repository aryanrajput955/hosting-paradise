...
const quickFacts = [
  { text: "Romantic zip-line adventures over tea gardens in Munnar." },
  { text: "Tranquil Shikara rides through Alleppey's backwaters." },
  { text: "Sunset views at Echo Point and Kundala Lake." },
  { text: "Cozy dinners amid coconut groves and paddy fields." },
];
...
// Highlights
const highlights = [
  { title: "Munnar Tea Gardens", image: highlightImages[0], desc: "Romantic walks and zip-line thrills." },
  { title: "Eravikulam National Park", image: highlightImages[2], desc: "Wildlife spotting and scenic dams." },
  { title: "Alleppey Backwaters", image: highlightImages[1], desc: "Shikara rides and resort relaxation." },
  { title: "Waterfalls En Route", image: highlightImages[3], desc: "Cheeyappara & Valara cascades." },
  { title: "Fort Kochi Exploration", image: highlightImages[4], desc: "Historic charm and Jew Town." },
];
...
const faqs = [
  ...
  { question: "What is the group size for this tour?", answer: "Private or small group (2–4 travelers) for an intimate and personalized honeymoon experience." },
  { question: "Are flights included?", answer: "No, flights/train to/from Cochin not included. Airport/rail transfers provided." },
  { question: "What is the accommodation standard?", answer: "3 nights in comfortable hotels/resort or houseboat on double-sharing basis, romantic setups available." },
  { question: "Can dietary requirements be accommodated?", answer: "Yes, vegetarian, Jain, and special requests with advance notice." },
  { question: "Is the tour shared or private?", answer: "Customizable; A/C vehicle for couples, English-speaking guide included." },
  { question: "What currency should I bring?", answer: "Indian Rupees (INR); cards accepted in major hotels." },
  { question: "What seasonal activities are available?", answer: "Tea tours in summer; backwater cruises year-round; itinerary adjusts accordingly." },
...
const importantInfo = [
  ...
  },
  {
    ...
    content: (
      <p>
        <strong>Pricing:</strong> Starting from ₹ [Insert Price] per person<br />
        <em>Price depends on travel dates, hotel category & room type. Contact us for a personalized quote.</em>
      </p>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-2">
        <p><strong>Winter (Oct–Mar):</strong> Pleasant weather for romantic hill and backwater escapes</p>
        <p><strong>Summer (Apr–May):</strong> Ideal for cooler hill stations and cruises</p>
        <p><strong>Monsoon (Jun–Sep):</strong> Lush greenery, but check for rain adjustments</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        ...
        <li>Pack light cotton wear and comfortable footwear; mild woolens for Munnar nights.</li>
        <li>Stay hydrated; bottled water in vehicle.</li>
        <li>Follow guide for activity safety.</li>
...
export default function RomanticKeralaHoneymoonGetaway4Days() {
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 to-[#00453A]/40 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            >
              Paradise Bliss Tours – 4 Days / 3 Nights
            </motion.p>
            <motion.button
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
        ...
        >
          <div className="space-y-4">
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
              Known as “God’s Own Country”, Kerala is a haven of misty hills, backwaters, tea gardens, and palm-lined canals — a dream escape for couples. This honeymoon journey blends romance, tranquility, and natural beauty to create unforgettable memories for newlyweds.
            </p>
            <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
              ...
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Focus:</strong> Kochi → Munnar → Alleppey → Kochi
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
              ...
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Vibe:</strong> Romantic, tranquil, natural
              </li>
            </ul>
          </div>
        ...
        >
          <div>
            ...
            <ul className="space-y-3 text-gray-700 font-sans">
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> 3 nights romantic accommodation</li>
              ...
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Airport pickup/drop + tolls</li>
            </ul>
          </div>
