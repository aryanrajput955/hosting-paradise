...
// Kashmir Winter Holidays Images (replace with actual paths)
const heroImage = "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Ancient_Temple%2C_Gulmarg.jpg/1280px-Ancient_Temple%2C_Gulmarg.jpg";
...
// Quick Facts about Winter Kashmir Holidays
const quickFacts = [
  { text: "Gulmarg's gondola offers views up to 9,000 feet in snow." },
  { text: "Pahalgam hosts festive bonfires during Christmas." },
  { text: "Sonmarg is known as the 'Meadow of Gold' in winter." },
  { text: "Dal Lake houseboats feature festive decorations in December." },
];
...
const itinerary = [
  {
    ...
    desc: "Arrive at Srinagar airport in the early afternoon; you’ll be welcomed by your Trip Captain and transferred to a charming houseboat. Post check-in, visit the famed Mughal gardens for a stroll. Evening: A soothing shikara ride on the iconic Dal Lake. Dinner & overnight stay aboard the houseboat."
  },
  {
    day: "Day 2",
    title: "Srinagar → Gulmarg (~50 km / 2 hrs)",
    desc: "After breakfast, drive to Gulmarg. On arrival, enjoy the Gondola cable car ride to witness panoramic snow-clad vistas. Evening at leisure; dinner & stay in Gulmarg."
  },
  {
    day: "Day 3",
    title: "Gulmarg → Drung Waterfall → Pahalgam (~142 km / 4 hrs)",
    desc: "Depart Gulmarg and visit the scenic Drung Waterfall en route. Continue on to Pahalgam, check-in, and evening at leisure. Dinner & stay in Pahalgam."
  },
  {
    day: "Day 4",
    title: "Pahalgam Sightseeing",
    desc: "Full day to explore Pahalgam’s beauty – valleys, riverside walks, etc. Late afternoon drive back to Srinagar (~90 km / 2 hrs). Dinner & overnight stay in Srinagar houseboat/hotel."
  },
  {
    day: "Day 5",
    title: "Sonmarg Excursion",
    desc: "After breakfast, enjoy a day excursion to Sonmarg. Evening return to Srinagar. Festive Christmas / New Year celebration: snacks, music, bonfire & cake (weather permitting). Dinner & overnight in Srinagar."
  },
  {
    day: "Day 6",
    title: "Departure from Srinagar",
    desc: "After breakfast, time permitting, depart for the airport and head back home with wonderful memories."
  },
];

// Highlights
const highlights = [
  { title: "Gulmarg Gondola", image: highlightImages[0], desc: "Panoramic snowy vistas from the cable car." },
  { title: "Pahalgam Valleys", image: highlightImages[1], desc: "Riverside walks in winter wonderlands." },
  { title: "Dal Lake Shikara", image: highlightImages[2], desc: "Serene evening rides on frozen waters." },
  { title: "Sonmarg Excursion", image: highlightImages[3], desc: "Festive meadows and snowy adventures." },
];

// FAQ data
const faqs = [
  { question: "What festive activities are included?", answer: "Christmas/New Year celebrations with snacks, music, bonfire, and cake in Srinagar (weather permitting)." },
  { question: "What is the group size for this tour?", answer: "Small group (6–12 travelers) for a festive and personalized holiday experience." },
  { question: "Are flights included?", answer: "No, airfare or train fare to/from Srinagar not included. Airport transfers provided." },
  { question: "What is the accommodation standard?", answer: "5 nights in comfortable houseboats/hotels on sharing basis, with festive touches." },
  { question: "Can dietary requirements be accommodated?", answer: "Yes, vegetarian and halal options available with advance notice." },
  { question: "Is the tour shared or private?", answer: "Shared group tour with tempo traveller transport and English-speaking trip-captain." },
  { question: "What if gondola is unavailable due to snow?", answer: "Alternative arrangements like scenic walks will be provided; flexibility ensured." },
  { question: "What is the age group for this trip?", answer: "Designed for 18-42 years; custom options for other groups on request." },
...
const importantInfo = [
      ...
      <div className="space-y-4">
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>Accommodation on sharing basis for 5 nights.</li>
            <li>Meal plan: 10 meals total – Dinner on Day 1; Breakfast & Dinner Days 2-5; Breakfast on Day 6.</li>
            <li>Comfortable transportation for sightseeing by tempo traveller.</li>
            <li>Experienced Trip Captain from ParadiseBliss Tours throughout the tour.</li>
            <li>Shikara ride (1 hour) on Dal Lake.</li>
            <li>Gondola Cable Car (Phase 1) tickets.</li>
            <li>Local cab arrangements for sightseeing: Aru, Betaab Valley, Chandanwadi & Drung Waterfall.</li>
            <li>All permits, driver allowances, tolls/parking/taxes included.</li>
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>5% GST.</li>
            <li>Lunches not mentioned in the itinerary.</li>
            <li>Adventure activities (skiing, snowmobile, sledging, ATV, horse-ride) unless specified.</li>
            <li>Airfare or train fare to & from Srinagar.</li>
            <li>Monument/sight-seeing entry fees unless stated.</li>
            <li>Personal expenses & shopping.</li>
            <li>Extra costs incurred due to delays, roadblocks or weather conditions.</li>
          </ul>
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <p>
        <strong>Starting from:</strong> ₹25,499 per person<br />
        <em>Group size and seasonal surcharges may apply. Contact for details.</em>
      </p>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-2">
        <p><strong>Christmas (Dec 20–Jan 5):</strong> Festive snow celebrations</p>
        <p><strong>Winter Peak (Dec–Feb):</strong> Heavy snow and holiday vibes</p>
        <p><strong>Early Winter (Nov):</strong> First snowfalls and milder crowds</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        <li>Arrive before 12 PM on Day 1 for full itinerary.</li>
        <li>Wear warm layers and sturdy boots for snow.</li>
        <li>First-aid kit available; inform of medical needs.</li>
        <li>Follow trip-captain for weather/road updates.</li>
        <li>Fitness for light walks; suitable for 18-42 years.</li>
...
export default function WinterKashmirHolidaysExtravaganza6DayPackage() {
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 to-[#00453A]/40 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            >
              Paradise Bliss Tours – 6 Days / 5 Nights Festive Edition
            </motion.p>
            <motion.button
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
        ...
        >
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
              ...
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Focus:</strong> Srinagar → Gulmarg → Pahalgam → Sonmarg
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Price:</strong> ₹25,499 starting from
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Vibe:</strong> Festive, snowy, celebratory
              </li>
            </ul>
          </div>
        ...
        >
          <div>
            ...
            <div className="flex items-baseline space-x-3">
              <span className="text-4xl font-bold text-[#00453A]">₹25,499</span>
              <span className="text-sm text-gray-600">starting from</span>
            </div>
            <p className="text-sm text-gray-600 mt-2 font-sans">Group size and seasonal surcharges may apply.</p>
            ...
            <ul className="space-y-3 text-gray-700 font-sans">
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> 5 nights festive accommodation</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Shikara ride & Gondola Phase 1</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Tempo traveller + trip-captain</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> 10 meals + first-aid kit</li>
            </ul>
          </div>
          ...
          >
            ...
            <div className="mb-4">
              <Image src={heroImage}
                ...
                quality={75}
              />
              <h3 className="mt-3 text-lg font-bold text-[#00453A] font-sans">Winter Kashmir Holidays Extravaganza – 6 Days / 5 Nights</h3>
            </div>
