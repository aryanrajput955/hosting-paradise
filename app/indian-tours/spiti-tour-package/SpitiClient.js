...
// FAQ data - Tailored for Spiti Valley
const faqs = [
  { question: "What is the duration of the Spiti Valley tour?", answer: "8 Days / 7 Nights, including transfers from Chandigarh." },
  { question: "Do I need prior trekking or high-altitude experience?", answer: "No prior experience required, but moderate fitness is recommended for high-altitude drives and short walks." },
  ...
  { question: "What is the best time for the Spiti Valley tour?", answer: "May to October for accessible roads; winter (Nov-Apr) via Shimla route for snow experiences." },
  ...
  { question: "Are transfers from Chandigarh included?", answer: "Yes, AC vehicle for entire trip including Chandigarh round-trip." },
  { question: "What should I pack for the trip?", answer: "Warm layers, gloves, sunglasses, sunscreen, comfortable walking shoes; nights can drop to 0°C or below." },
...
// Important Information data - Adapted for Spiti Valley
const importantInfo = [
  {
      ...
      <div className="space-y-4">
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>7 nights accommodation (homestay/hotel)</li>
            <li>All meals (breakfast & dinner)</li>
            <li>AC vehicle for entire trip</li>
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>Flights/train to Chandigarh</li>
            <li>Lunch & personal expenses</li>
            <li>Adventure activities (rafting/trek)</li>
  ...
  },
  {
    ...
    content: (
      <p>
        <strong>Sharing Price:</strong> Starting at ₹29,999<br />
        <em>Pricing varies by group size and season (May–Oct). Scheduled batches: 15th May, 10th Jun, 5th Sep, 10th Oct 2025. Early booking advised.</em>
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        Ideal for adventure seekers, photographers, and cultural explorers drawn to remote Himalayan villages, ancient monasteries, and stark desert landscapes. A soul-stirring odyssey of solitude and serenity.
      </p>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        <li>Manali-Kaza route open May–Oct; winter trips via Shimla. Itinerary flexible for weather/road conditions.</li>
        <li>AMS precautions: Hydrate, rest, acclimatize; consult doctor for high-altitude travel.</li>
        <li>Inner Line Permit mandatory; valid ID required.</li>
        <li>Group size 6-12; carry warm clothes, stay hydrated, and follow guide instructions.</li>
      </ul>
    ),
  },
];
        ...
        >
          <div className="space-y-4">
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
              Discover the raw beauty of Spiti Valley — ancient monasteries, high-altitude villages, and surreal landscapes. A journey into the heart of the cold desert Himalayas.
            </p>
            <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
              ...
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Destination:</strong> Spiti Valley (Chandigarh Round Trip)
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Price:</strong> Starting at ₹29,999
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
      ...
      >
        ...
        >
          <div>
            ...
            <p className="text-sm text-gray-600 mt-2 font-sans">Starting price per person. Includes homestay, permits & local guide.</p>
            ...
            <ul className="space-y-3 text-gray-700 font-sans">
              ...
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> All breakfasts + dinners</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> AC vehicle transfers</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Local guide & ILP</li>
            </ul>
          </div>
          ...
          >
            ...
            <div className="mb-4">
              <Image src={heroImage}
                ...
                quality={75}
              />
              <h3 className="mt-3 text-lg font-bold text-[#00453A] font-sans">Spiti Valley Himalayan Odyssey – 8 Days / 7 Nights</h3>
            </div>
