...
// Kashmir Backpacking Images (replace with actual paths)
const heroImage = "https://images.pexels.com/photos/25786569/pexels-photo-25786569.jpeg";
const highlightImages = [
  "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/Flora_of_Gulmarg_Wildlife_Sanctuary.jpg/250px-Flora_of_Gulmarg_Wildlife_Sanctuary.jpg",
  "https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/A_view_of_Pahalgam_valley.jpg/330px-A_view_of_Pahalgam_valley.jpg",
  "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Sonmarg_rishav7336.jpg/500px-Sonmarg_rishav7336.jpg",
  "https://images.travelandleisureasia.com/wp-content/uploads/sites/2/2022/12/26173504/Zaina-Kadal-Road-Srinagar.jpg",
];
const rightSideImage = "/img/logo.png";

// Quick Facts about Kashmir Backpacking
const quickFacts = [
  { text: "Gulmarg's gondola provides access to Asia's highest ski slopes." },
  { text: "Pahalgam offers pony rides through lush pine forests." },
  { text: "Sonmarg is a gateway to high-altitude treks and glaciers." },
  { text: "Srinagar's markets are filled with Pashmina shawls and saffron." },
];
...
const itinerary = [
  {
    ...
    desc: "Arrive in Srinagar and meet your Trip Captain. Check-in to your accommodation (hotel/houseboat per plan). In the afternoon, enjoy a relaxed stroll and explore local markets. Evening at leisure; dinner & overnight in Srinagar."
  },
  {
    day: "Day 2",
    title: "Srinagar → Gulmarg (~50 km / 2-3 hrs)",
    desc: "After breakfast, drive to Gulmarg. Explore Gulmarg’s meadows and if weather permits, enjoy the cable car (Gondola) for panoramic views. Dinner and overnight stay in Gulmarg."
  },
  {
    day: "Day 3",
    title: "Gulmarg → Pahalgam (~140-160 km / 4-5 hrs via scenic route)",
    desc: "Depart from Gulmarg post-breakfast. On route, soak in the changing landscapes. Arrive at Pahalgam, check-in, evening at leisure. Overnight stay in Pahalgam."
  },
  {
    day: "Day 4",
    title: "Pahalgam Sightseeing",
    desc: "Spend a full day exploring Pahalgam – valleys, riverside walks, optional pony rides or local treks. Evening: return drive to Srinagar. Overnight stay in Srinagar."
  },
  {
    day: "Day 5",
    title: "Sonmarg Excursion",
    desc: "After breakfast, proceed to Sonmarg (or an alternate scenic spot depending on season/access). Enjoy the high-altitude vistas, meadows, maybe some light trekking or nature walks. Return to Srinagar in the evening. Overnight stay in Srinagar."
  },
  {
    day: "Day 6",
    title: "Departure from Srinagar",
    desc: "After breakfast, check out and transfer to the airport / railway station for your onward journey. Trip ends with memories to cherish."
  },
];

// Highlights
const highlights = [
  { title: "Gulmarg Meadows", image: highlightImages[0], desc: "Cable car rides and alpine exploration." },
  { title: "Pahalgam Valleys", image: highlightImages[1], desc: "Riverside walks and pony adventures." },
  { title: "Sonmarg Vistas", image: highlightImages[2], desc: "High-altitude treks and meadows." },
  { title: "Srinagar Markets", image: highlightImages[3], desc: "Local culture and relaxed strolls." },
];

// FAQ data
const faqs = [
  { question: "What is the backpacking style of this trip?", answer: "Less luxury, more experience: moderate mobility for light treks, nature walks, and cultural immersion." },
  { question: "What is the group size for this tour?", answer: "Small group (6–12 travelers) for an adventurous and personalized backpacking vibe." },
  { question: "Are flights included?", answer: "No, airfare/train to/from Srinagar not included. Transfers provided." },
  { question: "What is the accommodation standard?", answer: "5 nights in scenic hotels/houseboats on sharing basis, focused on comfort and location." },
  { question: "Can dietary requirements be accommodated?", answer: "Yes, vegetarian and halal options available with advance notice." },
  { question: "Is the tour shared or private?", answer: "Shared group tour with comfortable transport and English-speaking trip-captain." },
  { question: "What activities are optional?", answer: "Pony rides, gondola, light treks; included sightseeing is core, extras at personal cost." },
...
const importantInfo = [
      ...
      <div className="space-y-4">
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>Accommodation for 5 nights on sharing basis.</li>
            <li>Meals as per plan (typically breakfast + dinner).</li>
            <li>Comfortable transportation for local transfers as per itinerary.</li>
            <li>Experienced Trip Captain from ParadiseBliss Tours throughout the tour.</li>
            <li>Sightseeing and transfers as per the itinerary.</li>
            <li>All inner permits / road-taxes / parking included.</li>
          </ul>
        </div>
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>Adventure activities (skiing, snowmobiling, high-altitude treks beyond plan) unless specified.</li>
            <li>Monument / entry fees unless mentioned.</li>
            <li>Personal expenses, shopping, tea/coffee stops etc.</li>
            <li>Any cost due to delays, weather or roadblocks beyond control.</li>
          </ul>
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <p>
        <strong>Starting from:</strong> ₹23,999 per person<br />
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        <p><strong>Spring (Mar–May):</strong> Blooming valleys and mild treks</p>
        <p><strong>Summer (Jun–Aug):</strong> Lush meadows and adventure</p>
        <p><strong>Autumn (Sep–Oct):</strong> Golden landscapes and clear skies</p>
        <p><strong>Winter (Nov–Feb):</strong> Snowy explorations (seasonal adjustments)</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        <li>Arrive before noon on Day 1 for smooth start.</li>
        <li>Moderate fitness for light treks and walks.</li>
        <li>Pack layers for varying weather and altitudes.</li>
        <li>Follow trip-captain for itinerary changes.</li>
        <li>Carry ID proof; inner permits handled.</li>
...
export default function KashmirBackpackingOdyssey6DayPackage() {
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 to-[#00453A]/40 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            >
              Paradise Bliss Tours – 6 Days / 5 Nights Adventure
            </motion.p>
            <motion.button
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
        ...
        >
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
              ...
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Price:</strong> ₹23,999 starting from
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Vibe:</strong> Adventurous, cultural, immersive
              </li>
            </ul>
          </div>
        ...
        >
          <div>
            ...
            <div className="flex items-baseline space-x-3">
              <span className="text-4xl font-bold text-[#00453A]">₹23,999</span>
            ...
            <ul className="space-y-3 text-gray-700 font-sans">
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> 5 nights backpacker accommodation</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Breakfast + dinner meals</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Comfortable transfers + trip-captain</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Core sightseeing + permits</li>
            </ul>
          </div>
          ...
          >
            ...
            <div className="mb-4">
              <Image src={heroImage}
                ...
                quality={75}
              />
              <h3 className="mt-3 text-lg font-bold text-[#00453A] font-sans">Kashmir Backpacking Odyssey – 6 Days / 5 Nights</h3>
            </div>
