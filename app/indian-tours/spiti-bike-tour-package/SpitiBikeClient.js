...
import DatePicker from 'react-datepicker';
  ...
  // Updated images for Spiti Valley Bike Tour theme (keep links same)
  ...
  // Quick Facts about Spiti Valley Bike Tour
  const quickFacts = [
  ...
  // Itinerary data - Updated for 8N/9D Spiti Valley Bike Tour
  const itinerary = [
    {
      day: "Day 1",
      title: "Delhi to Manali",
      desc: "Evening: Depart from Delhi around 9:30 PM in an AC vehicle. Overnight: Travel overnight to Manali."
    },
    {
      day: "Day 2",
      title: "Manali to Jibhi",
      desc: "Morning: Arrive in Manali. Activities: Pick up your Royal Enfield bikes. Test ride from Manali to Jibhi. Evening: Check-in to your accommodation in Jibhi. Overnight: Stay in Jibhi."
    },
    {
      day: "Day 3",
      title: "Jibhi to Chitkul",
      desc: "Morning: After breakfast, depart for Chitkul. Activities: Cross the famous Jalori Pass at an altitude of 10,000 ft. Arrive in Chitkul, the last inhabited village on the Indo-Tibet border. Evening: Explore the village and enjoy local cuisine. Overnight: Stay in Chitkul."
    },
    {
      day: "Day 4",
      title: "Chitkul to Kalpa",
      desc: "Morning: After breakfast, depart for Kalpa. Activities: Enjoy the scenic beauty of the Kinnaur Valley. Visit the Kinner Kailash range for panoramic views. Evening: Check-in to your accommodation in Kalpa. Overnight: Stay in Kalpa."
    },
    {
      day: "Day 5",
      title: "Kalpa to Tabo",
      desc: "Morning: After breakfast, depart for Tabo. Activities: Visit the Tabo Monastery, over 1,000 years old. Explore the ancient caves and murals. Evening: Check-in to your accommodation in Tabo. Overnight: Stay in Tabo."
    },
    {
      day: "Day 6",
      title: "Tabo to Kaza",
      desc: "Morning: After breakfast, depart for Kaza. Activities: Visit the Kye Monastery, the largest Buddhist monastery in Spiti. Explore the local market and interact with the locals. Evening: Check-in to your accommodation in Kaza. Overnight: Stay in Kaza."
    },
    {
      day: "Day 7",
      title: "Kaza to Chandratal Lake",
      desc: "Morning: After breakfast, depart for Chandratal Lake. Activities: Ride through the scenic landscapes of Spiti. Arrive at Chandratal Lake, also known as the Moon Lake. Evening: Set up camp near the lake. Overnight: Camping near Chandratal Lake."
    },
    {
      day: "Day 8",
      title: "Chandratal Lake to Manali",
      desc: "Morning: After breakfast, pack up camp and depart for Manali. Activities: Ride back through the scenic landscapes. Evening: Arrive in Manali and check-in to your accommodation. Overnight: Stay in Manali."
    },
    {
      day: "Day 9",
  ...
  // Highlights data - Updated for Spiti Valley Bike Tour
  const highlights = [
    { title: "Chitkul Village", image: highlightImages[0], desc: "Last Indian village on Indo-Tibet border." },
    { title: "Key Monastery", image: highlightImages[1], desc: "Ride to Spiti’s largest Buddhist monastery." },
    { title: "Chandratal Camping", image: highlightImages[2], desc: "Camp under stars at the Moon Lake." },
    { title: "Jalori Pass", image: highlightImages[3], desc: "Conquer 10,000 ft on your Royal Enfield." },
  ];

  // FAQ data - Tailored for Spiti Valley Bike Tour
  const faqs = [
    { question: "What bikes are provided for the tour?", answer: "Royal Enfield Classic 350 or similar, with fuel for the itinerary; mechanic support included." },
    { question: "Do I need prior biking experience?", answer: "Yes, experienced riders comfortable with high-altitude and off-road conditions; valid license required." },
    { question: "Is travel insurance included?", answer: "No, comprehensive insurance covering biking and high-altitude risks is recommended." },
    { question: "What is the best time for the Spiti Bike Tour?", answer: "June to September for open roads and mild weather; avoid monsoons and winters." },
    { question: "Can dietary requirements be accommodated?", answer: "Yes, vegetarian meals standard; specify preferences during booking." },
    { question: "What permits are needed?", answer: "Inner line permits for restricted areas are included; carry valid ID." },
    { question: "Are transfers from Delhi included?", answer: "Yes, AC vehicle for round-trip Delhi-Manali; local rides on bikes." },
    { question: "What should I pack for biking?", answer: "Riding gear, helmet, warm layers, gloves; weather unpredictable at high altitudes." },
    { question: "Is the tour suitable for solo riders?", answer: "Yes, with group support; solo bookings welcome on shared basis." },
    { question: "What is the cancellation policy?", answer: "Full refund minus fees if canceled 30+ days prior; details at booking." },
  ];

  // Important Information data - Adapted for Spiti Valley Bike Tour
  const importantInfo = [
    {
        ...
        <div className="space-y-4">
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>Accommodation: 2 nights Manali, 1 Jibhi, 1 Chitkul, 1 Kalpa, 1 Tabo, 2 Kaza, 1 camping.</li>
              <li>Meals: 8 breakfasts + 8 dinners.</li>
              <li>Royal Enfield bikes for entire trip.</li>
              <li>Experienced road captains & support staff.</li>
    ...
    },
    {
      ...
      content: (
        <p>
          <strong>Sharing Price:</strong> Starting at ₹44,999<br />
          <em>Pricing depends on group size, bike category, and season (June–September). Early booking recommended.</em>
        </p>
      ),
    },
    {
      ...
      content: (
        <p>
          Ideal for experienced bikers and adventure enthusiasts seeking high-altitude thrills, remote villages, and Himalayan serenity. A high-octane journey through Spiti's raw beauty and heritage.
        </p>
      ),
    },
    {
      ...
      content: (
        <ul className="list-disc pl-5 space-y-2">
          <li>Route open June–September; monsoons may affect high passes.</li>
          <li>Riding gear, helmet, gloves mandatory; carry spare fuel.</li>
          <li>Inner Line Permit required for foreigners.</li>
          <li>Itinerary subject to weather, roadblocks, or landslides.</li>
        </ul>
      ),
    },
  ];
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
                <li className="flex items-center">
                  ...
                  <strong className="mr-1">Duration:</strong> 8 Nights / 9 Days
                </li>
                <li className="flex items-center">
                  <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                ...
                <li className="flex items-center">
                  <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                  <strong className="mr-1">Price:</strong> Starting at ₹44,999
                </li>
                <li className="flex items-center">
                  <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                  <strong className="mr-1">Vibe:</strong> Adventurous, thrilling, cultural
                </li>
              </ul>
            </div>
          ...
          >
            <div>
              ...
              <div className="flex items-baseline space-x-3">
                <span className="text-4xl font-bold text-[#00453A]">₹44,999*</span>
              </div>
              <p className="text-sm text-gray-600 mt-2 font-sans">Starting price per person. Includes Royal Enfield, camping & support.</p>
              ...
              <ul className="space-y-3 text-gray-700 font-sans">
                <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Accommodation & camping</li>
                <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> 8 breakfasts + 8 dinners</li>
                <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Royal Enfield bikes & fuel</li>
                <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Road captains & support</li>
              </ul>
            </div>
            ...
            >
              ...
              <div className="mb-4">
                <Image src={heroImage}
                  ...
                  quality={75}
                />
                <h3 className="mt-3 text-lg font-bold text-[#00453A] font-sans">Spiti Valley Bike Itinerary – 8 Nights / 9 Days - Paradise Bliss Tours</h3>
              </div>
