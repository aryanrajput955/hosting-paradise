...
const heroImage = "https://images.unsplash.com/photo-1704365159747-1f7b8913044f?q=80&w=627&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
const highlightImages = [
  "https://images.pexels.com/photos/32262506/pexels-photo-32262506.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
  "https://images.unsplash.com/photo-1704365159747-1f7b8913044f?q=80&w=627&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  "https://images.unsplash.com/photo-1644773182204-f0bf03cae0cb?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  "https://images.unsplash.com/photo-1647938272908-564861fe4f49?q=80&w=1176&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  "https://images.unsplash.com/photo-1679849043239-5ecb74918e67?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
];
...
const quickFacts = [
  ...
  { text: "Discover cultural gems in Trivandrum's temples and museums." },
];
...
const itinerary = [
  {
    day: "Day 1",
    title: "Arrival at Kochi → Transfer to Munnar (~130 km / ~4 hrs)",
    desc: "Pick-up from Kochi airport or railway station. En route, stop at spice plantations, the scenic Cheeyappara & Valara waterfalls, Karadippara viewpoint and expansive tea gardens. Check-in at Munnar and overnight stay."
  },
  {
    day: "Day 2",
    title: "Munnar Sightseeing",
    desc: "Explore the hills of Munnar: tea estate walks, viewpoints, optional zip-lining for adventure. Overnight stay in Munnar."
  },
  {
    day: "Day 3",
    title: "Munnar → Alleppey/Kumarakom (~155 km / ~4 hrs)",
    desc: "Drive down from the hills to the backwaters region. Check-in to a homestay or houseboat in Alleppey or Kumarakom. Evening at leisure, enjoy village life and coconut-groves surroundings. Overnight stay in Alleppey/Kumarakom."
  },
  {
    day: "Day 4",
    title: "Alleppey/Kumarakom → Kovalam (~170 km / ~4.5 hrs)",
    desc: "After breakfast, proceed toward the southern beaches. Check-in at Kovalam beach resort/homestay. Evening beach stroll. Overnight stay in Kovalam."
  },
  {
    day: "Day 5",
    title: "Kovalam → Trivandrum Sightseeing",
    desc: "Morning at Kovalam beach, then short trip to Trivandrum for city sightseeing (temples, museums, beaches). Return to Kovalam or stay in Trivandrum as per comfort. Overnight stay."
  },
  {
    day: "Day 6",
    title: "Relaxation at Kovalam/Trivandrum",
    desc: "Use this day for leisure beach time, optional local excursions, Ayurvedic spa or simply relaxing by the sea. Overnight stay."
  },
  {
    day: "Day 7",
    title: "Departure from Trivandrum / Kovalam",
    desc: "After breakfast, check out and transfer to airport/railway for your onward journey."
  },
];

// Highlights
const highlights = [
  { title: "Munnar Tea Gardens", image: highlightImages[0], desc: "Tea estate walks and scenic viewpoints." },
  { title: "Backwaters Cruise", image: highlightImages[1], desc: "Houseboat or homestay in Alleppey/Kumarakom." },
  { title: "Kovalam Beach", image: highlightImages[3], desc: "Golden sands and sunset strolls." },
  { title: "Trivandrum Temples", image: highlightImages[2], desc: "Cultural sightseeing and museums." },
  { title: "Waterfalls En Route", image: highlightImages[4], desc: "Cheeyappara & Valara natural wonders." },
];
...
const importantInfo = [
      ...
      <div className="space-y-4">
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>Accommodation for 6 nights on sharing basis (mix of hill-station hotel/homestay + backwater houseboat/homestay + beach region stay).</li>
            <li>Daily meals as per plan (breakfast + some dinners).</li>
            <li>A/C vehicle for transfers and local sightseeing (as per programme).</li>
            <li>Toll tax, parking, driver allowance included.</li>
          </ul>
        </div>
        <div>
          <strong className="block mb-2">What's Not Included:</strong>
          <ul className="list-disc pl-5 space-y-1">
            <li>Airfare or train travel to/from the start/end point.</li>
            <li>Meals not mentioned.</li>
            <li>Any adventure activities (zip-lining, etc) unless specified.</li>
            <li>Monument/sight-seeing entry fees unless specified.</li>
            <li>Personal expenses, shopping, tips.</li>
            <li>Any cost due to weather, roadblocks or other unforeseen circumstances.</li>
          </ul>
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <p>
        <strong>Pricing:</strong> Starting from ₹ [Insert Starting Price] per person<br />
        <em>Final cost may vary by travel dates, group size & accommodation category. Contact us for a personalized quote.</em>
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        <li>Itinerary may change depending on local conditions (weather, road etc).</li>
        <li>For backpacking style: lighter luggage recommended, casual comfortable clothing.</li>
        <li>While this trip is moderate, guests should have basic mobility for walking in hills/backwater areas.</li>
        <li>Standard cancellation & date change policy applies.</li>
      </ul>
    ),
  },
];
...
export default function KeralaBackpackingEscape6Nights7Days() {
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 to-[#00453A]/40 flex items-center justify-center">
          <div className="text-center text-white px-4">
            ...
            >
              6 Nights / 7 Days Backpacking Adventure
            </motion.p>
            <motion.button
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
        ...
        >
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
              ...
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Focus:</strong> Kochi → Munnar → Alleppey/Kumarakom → Kovalam → Trivandrum
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
        ...
        >
          <div>
            ...
            <ul className="space-y-3 text-gray-700 font-sans">
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> 6 nights accommodation on sharing basis</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Daily breakfast + some dinners</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> A/C vehicle transfers & sightseeing</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Toll, parking & driver allowances</li>
            </ul>
          </div>
          ...
          >
            ...
            <div className="mb-4">
              <Image src={heroImage}
                ...
                quality={75}
              />
              <h3 className="mt-3 text-lg font-bold text-[#00453A] font-sans">Kerala Backpacking Escape – 6 Nights / 7 Days</h3>
            </div>
