...
// === Quick Facts (Adventures) ===
const quickFacts = [
  { text: "Paragliding in Bir Billing – the world’s second-highest site." },
  { text: "Trek to Triund – a 9km hike with panoramic Dhauladhar views." },
  { text: "River rafting in Kullu on the Beas River." },
  { text: "Skiing in Solang Valley during winter." },
];

// === Best Time to Visit (3 Seasons) ===
const itinerary = [
  {
    day: "Summer",
    title: "March to June",
    desc: "Perfect for sightseeing, trekking, and exploring hill stations like Shimla, Manali, and Dharamshala. Pleasant weather, blooming valleys, and clear skies."
  },
  {
    day: "Monsoon",
    title: "July to September",
    desc: "The valleys bloom with freshness. Lush greenery, waterfalls, and serene vibes. Note: Landslides possible in some areas."
  },
  {
    day: "Winter",
    title: "October to February",
    desc: "Best for snow lovers, honeymoon trips, and winter sports. Snow-covered mountains, skiing, and magical winter landscapes."
  },
];

// === Highlights → 6 Best Places ===
const highlights = [
  { title: "Shimla", image: highlightImages[0], desc: "The Queen of Hills – Mall Road, Ridge, Jakhoo Temple & toy train." },
  { title: "Manali", image: highlightImages[1], desc: "Adventure hub – Rohtang Pass, Solang Valley, rafting & skiing." },
  { title: "Dharamshala & McLeodganj", image: highlightImages[2], desc: "Home of Dalai Lama – Tibetan culture, monasteries & peace." },
  { title: "Dalhousie & Khajjiar", image: highlightImages[3], desc: "Mini Switzerland – pine forests, meadows, serene lakes." },
  { title: "Kasol & Tosh", image: highlightImages[4], desc: "Backpacker’s paradise in Parvati Valley – trekking & chill vibes." },
  { title: "Spiti Valley", image: highlightImages[5], desc: "Cold desert, ancient monasteries, starry skies." },
];

// === FAQs → Culture, Food & Festivals ===
const faqs = [
  { question: "What makes Himachal culture unique?", answer: "Warm hospitality, colorful attire, and vibrant festivals like Kullu Dussehra, Halda, and Losar reflect the region’s rich traditions." },
  { question: "What local food should I try?", answer: "Don’t miss Siddu, Babru, Thukpa, and fresh Trout Fish – hearty, soul-warming, and authentic Himachali flavors." },
  { question: "Is Himachal safe for solo travelers?", answer: "Yes! Locals are welcoming, and popular routes are well-traveled. Always follow local advice during monsoons." },
  { question: "What adventure activities are available?", answer: "Trekking, paragliding, rafting, skiing, camping by Beas River, and exploring apple orchards in Kinnaur." },
  { question: "How do I reach Himachal?", answer: "Fly to Chandigarh or Bhuntar (Kullu). Buses and taxis connect to Shimla, Manali, etc. Toy train from Kalka to Shimla is scenic!" },
];
...
const importantInfo = [
      ...
      <div className="space-y-4">
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>Accommodation in hotels, homestays, or camps (as per package).</li>
            <li>Daily breakfast & select meals.</li>
            <li>Guided tours to major attractions.</li>
            <li>Adventure activities (if booked).</li>
            <li>Local transport (taxi, bus, or shared jeep).</li>
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>Flight/train tickets to Himachal.</li>
            <li>Personal expenses, tips, or optional activities.</li>
  ...
  },
  {
    ...
    content: (
      <p>
        <strong>Starting Price:</strong> ₹24,999 (per person, double-sharing)<br />
        <em>Custom packages available for families, groups, or solo travelers.</em>
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        Perfect for nature lovers, adventure seekers, honeymooners, families, and backpackers. Whether you seek peace in the mountains or thrill on the trails — Himachal has it all.
      </p>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        <li>Carry warm clothes in winter; light woolens in summer.</li>
        <li>Stay hydrated and use sunscreen at high altitudes.</li>
        <li>Respect local culture: remove shoes in temples, avoid loud behavior.</li>
        <li>Book in advance during peak season (May-Jun, Dec-Jan).</li>
      </ul>
    ),
  },
];

// === Highlight Card (Fixed rotate classes) ===
const HighlightCard = memo(({ highlight, index, variants }) => (
  <motion.div
    variants={variants}
    whileHover={{ scale: 1.02 }}
    className="relative bg-white rounded-2xl shadow-xl overflow-hidden ${index % 2 === 0 ? 'rotate-2' : 'neg-rotate-2'}"
    initial="hidden"
    animate="show"
  >
...
export default function HimachalTourPackage() {
  ...
  return (
    <div className="bg-[#F1FDF3] min-h-screen">
        ...
        >
          <div className="space-y-4">
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
              Cradled in the majestic Himalayas, Himachal Pradesh is where nature paints its most beautiful picture. From snow-covered peaks to sparkling rivers and ancient temples, every corner offers peace, adventure, and warm smiles.
            </p>
            <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Best For:</strong> Nature, Adventure, Honeymoon, Peace
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Destinations:</strong> Shimla, Manali, Spiti, Kasol & more
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Starting Price:</strong> ₹24,999
              </li>
            </ul>
          </div>
      ...
      >
        ...
        >
          <div>
            <h3 className="text-2xl font-semibold text-[#00453A] mb-4 font-sans">Starting Price</h3>
            ...
            <p className="text-sm text-gray-600 mt-2 font-sans">Custom packages for 3–15 days. Group discounts available.</p>
            ...
            <ul className="space-y-3 text-gray-700 font-sans">
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Stay, meals, local transport</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Guided tours & entry tickets</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Adventure activities (optional)</li>
            </ul>
          </div>
          <div className="flex flex-col items-center space-y-4">
            <div className="w-full max-w-sm bg-white border-2 border-dashed border-[#00453A] rounded-lg p-6 shadow-md">
              <h4 className="text-xl font-semibold text-[#00453A] font-sans mb-3 flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2" /> Adventure Highlight
              </h4>
        ...
        <div className="space-y-4">
          {importantInfo.map((info, index) => (
            <motion.div
              ...
              transition={{ duration: 0.3 }}
              viewport={{ once: true }}
              className="bg-[#E4DECF] border-l-4 border-[#F5A623] rounded-r-lg shadow-md hover:shadow-lg"
            >
              <button
        ...
        <div className="space-y-3">
          {faqs.map((faq, index) => (
            <motion.div
              ...
              transition={{ duration: 0.3 }}
              viewport={{ once: true }}
              className="bg-[#E4DECF] border border-[#E5E7EB] rounded-lg shadow-sm hover:shadow-md"
            >
              <button
        ...
        >
          ...
          >
            ...
            <div className="mb-4">
              ...
              />
              <h3 className="mt-3 text-lg font-bold text-[#00453A] font-sans">Plan Your Himachal Trip</h3>
            </div>
      ...
      <style jsx global>{`
        ...
        .neg-rotate-2 { transform: rotate(-2deg); }
      `}</style>
    </div>
  );
}