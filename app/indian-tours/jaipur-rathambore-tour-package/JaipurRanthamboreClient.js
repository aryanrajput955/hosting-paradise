...
// Jaipur & Ranthambore Images (using online links)
const heroImage = "https://images.unsplash.com/photo-1706961121527-4017856774c7?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
const highlightImages = [
  "https://images.unsplash.com/photo-1599661046289-e31897846e41?q=80&w=627&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  "https://images.unsplash.com/photo-1706961121527-4017856774c7?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  "https://images.unsplash.com/photo-1725990076174-a3448eb86e76?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  "https://images.unsplash.com/photo-1706961121783-4ae6c933983a?q=80&w=735&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
];
const rightSideImage = "/img/logo.png";

// Quick Facts about Jaipur & Ranthambore
const quickFacts = [
  { text: "Jaipur is known as the 'Pink City' due to its pink-hued buildings." },
  { text: "Ranthambore National Park is home to over 40 Bengal tigers." },
  { text: "Amber Fort features a stunning light and sound show in the evenings." },
  { text: "Jantar Mantar in Jaipur houses the world's largest stone sundial." },
];
...
const itinerary = [
  {
    day: "Day 1",
    title: "Arrival in Jaipur – Royal Heritage",
    desc: "Morning: Arrive at Jaipur Airport/Railway Station; transfer to your hotel. Afternoon: Visit the iconic City Palace, the majestic Hawa Mahal, and the astronomical marvel Jantar Mantar. Evening: Optionally, visit the serene Birla Mandir. Overnight: Stay at a 3-star hotel in Jaipur."
  },
  {
    day: "Day 2",
    title: "Jaipur Sightseeing – Forts & Local Markets",
    desc: "Morning: Explore the grand Amber Fort, enjoy an optional elephant ride (subject to availability), and visit the Jal Mahal for a photo stop. Afternoon: Visit the Sheesh Mahal (Hall of Mirrors) and the Maharaja's City Palace. Evening: Free time to explore local markets or relax. Overnight: Stay at the same hotel in Jaipur."
  },
  {
    day: "Day 3",
    title: "Jaipur to Ranthambore – Wildlife Adventure",
    desc: "Morning: After breakfast, drive to Ranthambore (approx. 3.5 hours). Afternoon: Check-in at your resort; visit the historic Ranthambore Fort and the Trinetra Ganesh Temple. Evening: Leisure time to relax at the resort. Overnight: Stay at a resort in Ranthambore."
  },
  {
    day: "Day 4",
    title: "Ranthambore Safari & Departure",
    desc: "Early Morning: Embark on a thrilling Jeep Safari in Ranthambore National Park to spot the majestic Bengal tigers and other wildlife. Afternoon: Return to the resort for breakfast. Evening: Drive back to Jaipur; drop at Jaipur Airport/Railway Station for your onward journey."
  },
];

// Highlights
const highlights = [
  { title: "Amber Fort", image: highlightImages[0], desc: "Majestic hilltop fortress with elephant rides." },
  { title: "City Palace", image: highlightImages[1], desc: "Royal residence blending Rajput and Mughal architecture." },
  { title: "Ranthambore Safari", image: highlightImages[2], desc: "Wildlife spotting in a premier tiger reserve." },
  { title: "Hawa Mahal", image: highlightImages[3], desc: "Iconic 'Palace of Winds' for royal women." },
];

// FAQ data
const faqs = [
  { question: "What is the best time to visit Jaipur and Ranthambore?", answer: "October to March offers pleasant weather ideal for sightseeing and safaris." },
  { question: "Is the jeep safari guaranteed to spot tigers?", answer: "Sightings depend on wildlife patterns, but Ranthambore is renowned for tiger visibility." },
  { question: "Are flights included in the package?", answer: "No, airfare or train fare to/from Jaipur is not included; transfers are provided." },
  { question: "What is the accommodation standard?", answer: "3-star hotels in Jaipur and resorts in Ranthambore on sharing basis." },
  { question: "Can dietary requirements be accommodated?", answer: "Yes, vegetarian and Jain options available with advance notice." },
  { question: "Is the tour shared or private?", answer: "Private AC vehicle for a personalized experience." },
  { question: "What if elephant rides are unavailable?", answer: "Jeep rides are offered as an alternative at Amber Fort." },
  { question: "What is the cancellation policy?", answer: "Full refund (minus fees) 45+ days prior; partial 15–45 days; no refund within 15 days." },
];
      ...
      <div className="space-y-4">
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>Accommodation: 2 nights in Jaipur and 1 night in Ranthambore with breakfast and dinner.</li>
            <li>Transportation: Private AC vehicle for all transfers and sightseeing.</li>
            <li>Safari: 1 Jeep safari in Ranthambore National Park.</li>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-2">
        <p><strong>October to March:</strong> Pleasant weather for sightseeing and outdoor activities</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-5 space-y-2">
        <li>Carry valid ID proof for safaris and entries.</li>
        <li>Wear comfortable shoes for fort explorations.</li>
        <li>Stay hydrated; bottled water provided in vehicle.</li>
        <li>Follow guide instructions during wildlife safaris.</li>
        <li>Dress modestly for temple visits.</li>
        <li>Emergency contact available 24/7 via trip-captain.</li>
      </ul>
    ),
  },
];
...
export default function JaipurRanthambore4DayPackage() {
        ...
        >
          <div className="space-y-4">
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
              Immerse yourself in the royal heritage of Jaipur and the thrilling wildlife of Ranthambore. This package blends majestic forts, vibrant markets, and tiger safaris for an unforgettable Rajasthan adventure.
            </p>
            <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
              ...
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Focus:</strong> Jaipur → Ranthambore
              </li>
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
              ...
              <li className="flex items-center">
                <AiOutlineStar className="text-[#F5A623] mr-2 flex-shrink-0" />
                <strong className="mr-1">Vibe:</strong> Heritage, wildlife, cultural
              </li>
            </ul>
          </div>
        ...
        >
          <div>
            ...
            <ul className="space-y-3 text-gray-700 font-sans">
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> 3 nights accommodation</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Private AC vehicle transfers</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> 1 Ranthambore jeep safari</li>
              <li className="flex items-center"><AiOutlineStar className="text-[#F5A623] mr-2" /> Breakfast + dinner meals</li>
            </ul>
          </div>
      ...
      {isModalOpen && (
        ...
        >
          ...
          >
            ...
            <div className="mb-4">
              <Image src={heroImage}
                alt="Jaipur & Ranthambore"
                width={400}
                height={128}
                className="w-full h-32 object-cover rounded-lg"
                quality={75}
              />
              <h3 className="mt-3 text-lg font-bold text-[#00453A] font-sans">Jaipur & Ranthambore – 3 Nights / 4 Days</h3>
            </div>
